    ...
    <el-row class="header">
      <div class="head-bar" v-if="adminInfo.name">
        <div class="left">
          ...
          <span slot="title" style="font-size: 16px;font-weight: bolder">天商电影</span>
        </div>
        <div class="right">
          <img
      ...
      <div class="section">
        <div class="nav-bar">
          <el-menu :default-active="currentMenuIndex" class="el-menu-vertical">
              ...
              <el-menu-item index="/Box_office" @click="handleMenuItemClick('/box_office')">
...
export default {
  ...
  methods: {
    ...
    handleMenuItemClick(path){
      this.$router.push('/home_cinema'+path);
...
#homecinema .el-dropdown-link {
  cursor: pointer;
  font-size: 14px;
}
#homecinema .el-dropdown-link:hover {
  color: #409eff;
}
#homecinema .el-icon-arrow-down {
  font-size: 12px;
}
#homecinema .el-menu{
  border: none;
...
#homecinema .el-menu-item{
  height: 50px;
  line-height: 50px;
}
#homecinema .el-menu-item,#homecinema .el-menu-item i{
  color: #3c4043;
}
#homecinema .el-menu-item.is-active {
  color: #fff;
  background-color: #409eff;
}
#homecinema .el-menu-item.is-active i {
  color: #fff;
}
</style>
