  ...
  <div id="movie-manage">
    ...
    <div class="movie-table">
      <el-table border :data="tableData">
        ...
        <el-table-column label="上映时间" prop="public_date"> </el-table-column>
  ...
  methods: {
    ...
    async manageMovieInfo() {
      if (
        ...
        this.movieInfo.actor &&
        this.movieInfo.movie_long &&
        /^[1-9]{1}[0-9]+分钟$/.test(this.movieInfo.movie_long) &&
        this.movieInfo.type &&
        this.movieInfo.language &&
        this.movieInfo.public_date &&
        this.movieInfo.intro
      ) {
        ...
        if (json.success_code === 200) {
          ...
          if (this.dialogTitle === "编辑电影信息") {
            json = await updateMovieInfo(
              this.movieInfo.movie_id,
              this.movieInfo.name,
              this.movieInfo.poster,
              this.movieInfo.director,
              this.movieInfo.actor,
