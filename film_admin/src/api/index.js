...
//获取当前影院的电影评论
export const ZgetCurrentPageComment = (currentPage,pageSize,input)=>ajax('/api/admin/ZgetCurrentPageComment',{currentPage,pageSize,input});
//通过当前评论
...
//获取当前电影的订单
export const ZgetCurrentPageOrder = (currentPage,pageSize,input)=>ajax('/api/admin/ZgetCurrentPageOrder',{currentPage,pageSize,input});
//删除订单
...
//获取特定影院的影厅
export const ZgetCurrentPageHall = (currentPage,pageSize,input) => ajax('/api/admin/ZgetCurrentPageHall',{currentPage,pageSize,input})
//删除影厅
...
//添加特定影院的影厅信息
export const ZaddHallInfo = (cinemaId,hallName)=>ajax('/api/admin/ZaddHallInfo',{cinemaId:1,hallName},'POST');
//获取当前页排片
...
//获取当前影院的排片
export const ZgetCurrentPageMovieSchedule = (currentPage,pageSize,input)=>ajax('/api/admin/ZgetCurrentPageMovieSchedule',{currentPage,pageSize,input});
//获取所有电影
export const getAllMovie = ()=>ajax('/api/admin/getAllMovie');

//获取影院电影票房
export const getBoxOfficeByCinemaId = ()=>ajax('/api/admin/getBoxOfficeByCinemaId');
