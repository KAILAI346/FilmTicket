      ...
      <div class="order-container" v-if="myOrderInfo.length">
        <div class="item"  v-for="(item,value) in myOrderInfo" >
          ...
          <div class="item-top">
            ...
            <span class="status">{{item.order_date}}下单</span>
          </div>
          ...
          <div class="item-bottom">
            ...
            <div>取票码：<span>{{ item.phone_code }}</span></div>
            <el-button 
              type="danger" 
              size="mini" 
              icon="el-icon-delete" 
...
<script>
    ...
    import {deleteMyOrderById} from '../../../api/index'
    ...
    export default {
        ...
        methods:{
          ...
          async deleteOrder(id){
            this.$alert('订单已删除，款项自动返还！')
            let json = await deleteMyOrderById(id);
